...
export const getClassNames = ({
  ...
  const allClassNames: ClassNames = {
    ...
    caption_label: cn('text-sm font-medium leading-none', variant && 'text-(--calendar-theme-color)'),
    ...
    outside: cn('text-muted-foreground', !showOutsideDays && 'invisible pointer-events-none'),
