...
export const AspectRatio = forwardRef((props: IAspectRatio, ref: LegacyRef<HTMLDivElement> | undefined) => {
  const { children, className = '', ratio = 1 / 1, style = {}, ...otherProps } = props
