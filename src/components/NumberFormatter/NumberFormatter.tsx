...
export function NumberFormatter({ displayType = 'text', value, defaultValue, ...others }: NumberFormatterProps) {
  if (value === undefined && defaultValue === undefined) {
    return null
  }

  return <NumericFormat displayType={displayType} value={value} defaultValue={defaultValue} {...others} />
}
