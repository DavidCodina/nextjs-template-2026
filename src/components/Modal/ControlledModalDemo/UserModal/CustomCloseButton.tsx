...
export const CustomCloseButton = forwardRef<CustomCloseButtonRef, CustomCloseButtonProps>(
  ({ className, ...otherProps }, ref) => {
    return (
      <button aria-label='Close' ref={ref} className={cn(baseClasses, className)} {...otherProps}>
