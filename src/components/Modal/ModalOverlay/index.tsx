...
export const ModalOverlay = ({ children, className = '', style = {}, ...otherProps }: ModalOverlayProps) => {
  return (
    <Dialog.Overlay className={cn(baseClasses, className)} data-slot='modal-overlay' style={style} {...otherProps}>
      {children}
    </Dialog.Overlay>
  )
}
