...
export const ModalFooter = ({ children, className = '', style = {}, ...otherProps }: ModalFooterProps) => {
  /* ======================
          return
  ====================== */

  return (
    <div className={cn(baseClasses, className)} data-slot='alert-modal-footer' style={style} {...otherProps}>
      {children}
    </div>
  )
}
