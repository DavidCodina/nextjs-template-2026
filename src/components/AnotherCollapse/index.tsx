...
import { useState, useEffect, useLayoutEffect, useRef, Ref, useImperativeHandle } from 'react'

export type CollapseProps = React.ComponentPropsWithoutRef<'div'> & {
  isOpen: boolean
  disableTransition?: boolean
  duration?: number
  ref?: Ref<{ current: HTMLDivElement | null }>
}

/* ========================================================================
                                Collapse
======================================================================== */
// Don't want to use the Radix Collapsible? Here's an all custom Collapse.
