...
type CarouselIndicatorsProps = React.ComponentProps<'div'> & {
  ...
  indicatorStyle?: React.CSSProperties | ((isSelected: boolean) => React.CSSProperties)
  customIndicator?: (key: number, isSelected: boolean, onClick: () => void) => React.JSX.Element
}
...
export const CarouselIndicators = ({
  ...
  return (
    <div className={cn(baseClasses, className)} data-slot='carousel-indicators' style={style} {...props}>
