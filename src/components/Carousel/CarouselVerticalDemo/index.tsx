...
import { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious, CarouselIndicators } from '../'
    ...
    >
      ...
      >
        {items.map((item) => (
          <CarouselItem key={item.id}>
            <div className={`flex h-full items-center justify-center ${item.bg}`}>
      ...
      <CarouselIndicators
        ...
        customIndicator={(key, isSelected, onClick) => {
          return <CustomIndicator key={key} isSelected={isSelected} onClick={onClick} />
        }}
