...
export const CustomIndicator = ({
  ...
  return (
    <button className={cn(baseClasses, className)} onClick={onClick} style={style} type='button' {...props}>
      {isSelected && <div className='h-2/3 w-2/3 rounded-full border-[0.5px] border-sky-900 bg-sky-500' />}
    </button>
  )
}
