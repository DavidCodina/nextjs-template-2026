...
export const CarouselContent = ({
  ...
  return (
    <div className={cn('overflow-hidden', className)} data-slot='carousel-content' ref={carouselRef} style={style}>
      <div
        className={cn('flex', orientation === 'horizontal' ? 'h-full' : 'h-full flex-col', innerClassName)}
        style={innerStyle}
        {...props}
      >
        {children}
