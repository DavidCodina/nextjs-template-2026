...
export const CardDemo = () => {
  ...
  return (
    <section className={`mx-auto grid grid-cols-[repeat(auto-fill,minmax(300px,400px))] justify-center gap-6`}>
      {images.map((image, index) => (
        <Card className='' key={index}>
          ...
          <CardContent className=''>
            <p className=''>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore repudiandae fuga perferendis voluptatum
              commodi, qui sed molestiae iure ad fugiat nulla! Alias voluptates quia quod quisquam natus laboriosam
              expedita ducimus consequuntur. Aliquid, maiores mollitia exercitationem facere laborum iste corrupti quas
              sed eveniet deleniti suscipit, fugiat quod ut molestiae temporibus harum?
            </p>
          </CardContent>
