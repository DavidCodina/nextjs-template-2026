...
import { Button, Stepper, Step, StepContent, CompletedContent } from '@/components'
...
export function StepperDemo() {
  ...
  const stepData: Omit<React.ComponentProps<typeof Step>, 'index'>[] = [
    ...
    },
    {
      ...
      label: 'Step 2',
      description: <div className='max-w-[160px]'>Confirm Email. A longer description for testing...</div>,
    ...
    return (
      <>
        <StepContent show={activeIndex === 0}>
          ...
          <p className='mb-4'>
            This <code className='text-pink-500'>Stepper</code> is inspired by Chakra UI, Mantine and MUI. However, most
            associated components are representational/dumb. Ultimately, this means a litte more work on the consuming
            side, but a much less complex internal implementation.
          </p>

          <p>
            Generally, you're going to want to have external control over the{' '}
            <code className='text-pink-500'>activeIndex</code>. Following that pattern, it just made sense to
            externalize other things like <code className='text-pink-500'>isActive</code>,{' '}
            <code className='text-pink-500'>isCompleted</code>, <code className='text-pink-500'>isValid</code> etc.
          </p>
        </StepContent>
        ...
        <StepContent show={activeIndex === 1}>
          ...
          <p className='mb-4'>
            <Info className='text-primary mr-1 inline' /> Icons are optional. The default behavior is to show the step
            (i.e., <code className='size-[1em] text-pink-500'>index + 1</code>), or a check when{' '}
            <code className='text-pink-500'>isCompleted</code>.
          </p>

          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad error voluptatum totam natus vero placeat velit
            veniam eum, blanditiis modi, quod laborum unde quidem similique, quos voluptatem delectus dolore optio
            dolores a eos in. Nam minima at modi, mollitia accusamus omnis sunt totam facilis inventore. Tempore itaque
        ...
        <StepContent show={activeIndex === 2}>
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad error voluptatum totam natus vero placeat velit
          veniam eum, blanditiis modi, quod laborum unde quidem similique, quos voluptatem delectus dolore optio dolores
          a eos in. Nam minima at modi, mollitia accusamus omnis sunt totam facilis inventore. Tempore itaque harum
          eaque explicabo?
        </StepContent>

        <CompletedContent show={activeIndex === totalSteps}>
          <h3 className='text-primary text-xl font-black'>Completion!</h3>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores neque aut architecto accusantium ea laborum
          possimus libero optio consequuntur, deleniti ex facere explicabo alias repellat ipsa sequi placeat vel!
          Placeat harum quaerat consequuntur excepturi aspernatur veritatis facilis repellendus quis. Dicta similique
          dolorum qui omnis. Corrupti quaerat optio eius odio illo!
        </CompletedContent>
      </>
    )
  }
  ...
  const renderControls = () => {
    return (
      <div className='mt-6 flex justify-center gap-4'>
        <Button onClick={handlePrevious} disabled={activeIndex === 0} style={{ minWidth: 100 }}>
          Back
        </Button>
        <Button onClick={handleNext} disabled={activeIndex === totalSteps} style={{ minWidth: 100 }}>
  ...
  return (
    <section className='mx-auto mt-12'>
      <div className='mb-12 flex flex-wrap justify-center gap-4'>
        ...
        <Button className='' onClick={() => setAlternativeLabel((v) => !v)} style={{ minWidth: 200 }}>
