...
const customColors: AlertVariant[] = ['primary', 'secondary', 'info', 'success', 'warning', 'destructive']
...
export const AlertDemo = () => {
  ...
  return (
    <>
      ...
      <section className='bg-card mx-auto mb-6 max-w-[800px] space-y-6 rounded-lg border p-6 shadow'>
        <h2 className='text-primary mb-4 font-bold'>Custom Color Variants (Outline):</h2>
      ...
      <section className='bg-card mx-auto mb-6 max-w-[800px] space-y-6 rounded-lg border p-6 shadow'>
        <h2 className='text-primary mb-4 font-bold'>Tailwind Color Variants (Outline):</h2>
  ...
  return variants.map((variant, index) => {
    ...
    return (
      <Alert
        ...
        className=''
      >
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti dolore possimus at culpa suscipit accusantium
        optio porro blanditiis nesciunt minus architecto, quis laboriosam?
      </Alert>
    )
  })
}
