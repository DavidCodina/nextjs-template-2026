...
export type SelectValueType = React.ComponentProps<typeof SelectPrimitive.Item>['value']

type SelectProps = Omit<React.ComponentProps<typeof SelectPrimitive.Root>, 'onValueChange' | 'onChange'> & {
