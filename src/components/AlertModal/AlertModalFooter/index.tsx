...
export const AlertModalFooter = ({ children, className = '', style = {}, ...otherProps }: ModalFooterProps) => {
  /* ======================
          return
  ====================== */

  return (
    <div className={cn(baseClasses, className)} data-slot='modal-footer' style={style} {...otherProps}>
      {children}
    </div>
  )
}
