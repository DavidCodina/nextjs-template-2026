...
export const AlertModalContent = ({ children, className = '', style = {}, ...otherProps }: AlertModalContentProps) => {
  return (
    <AlertDialog.Content className={cn(baseClasses, className)} data-slot='modal-content' style={style} {...otherProps}>
      {children}
    </AlertDialog.Content>
  )
}
