...
const CardPlaceholder = ({ animation = 'wave', style = {}, className = '' }: any) => {
  return (
    <section
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <Placeholder animation={animation} size='lg' style={{ marginBottom: 5, width: '70%' }} />
          <Placeholder animation={animation} size='xs' style={{ marginBottom: 5 }} />
          <Placeholder animation={animation} size='xs' style={{ fontSize: 0, width: '75%' }} />
        </div>
      ...
      <Placeholder animation={animation} style={{ marginBottom: 8, marginLeft: '5%', width: '95%' }} />
      <Placeholder animation={animation} style={{ marginBottom: 8 }} />
      <Placeholder animation={animation} style={{ marginBottom: 8 }} />
      <Placeholder animation={animation} style={{ marginBottom: 20, width: '75%' }} />
