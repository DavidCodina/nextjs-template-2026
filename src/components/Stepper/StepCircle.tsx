...
export const StepCircle = ({
  ...
  icon = isLoading ? <LoaderCircle className='animate-spin' /> : isValid === false ? <X /> : icon
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCompleted && isActive && `data-[valid=true]:text-success data-[valid=true]:border-success`,
        isCompleted &&
          !isActive &&
          isValid === true &&
