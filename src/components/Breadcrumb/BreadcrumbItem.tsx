...
export const BreadcrumbItem = ({
  ...
  React.useLayoutEffect(() => {
    ...
    const items = parent!.querySelectorAll<HTMLElement>('[data-slot="breadcrumb-item"]')
  ...
  const renderItemChild = () => {
    ...
    const linkClasses = cn(
      ...
      !active && 'text-(--breadcrumb-link-color) hover:text-(--breadcrumb-link-hover-color)',
    ...
    return (
      <Comp className={linkClasses} data-slot='breadcrumb-link' style={linkStyle} {...otherProps}>
        {children}
      </Comp>
    )
  }
  ...
  return (
    <>
      ...
      <li className={className} data-slot='breadcrumb-item' ref={listItemRef} style={style}>
        {renderItemChild()}
      </li>
    </>
  )
