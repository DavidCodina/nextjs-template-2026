    ...
    return (
      ...
      >
        <SidebarGroup>
          ...
          <CollapsibleContent className='CollapsibleContent'>
            <SidebarGroupContent>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, cum. Minima laborum vel esse soluta,
              exercitationem voluptatem error at modi asperiores, facere alias voluptatum veritatis quia iusto nesciunt
              nemo illo repellat amet, reprehenderit pariatur. Quae possimus iure, inventore quasi labore sunt, modi qui
              architecto asperiores, fugiat nemo! Repellendus molestiae, molestias ullam id ipsa at deserunt nobis
              blanditiis tenetur veritatis asperiores accusantium non officia numquam voluptatem. Illo debitis fugit
              magnam quos blanditiis modi, ipsa harum nisi!
            </SidebarGroupContent>
          </CollapsibleContent>
        </SidebarGroup>
      </Collapsible>
