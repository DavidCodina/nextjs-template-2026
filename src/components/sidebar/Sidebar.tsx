...
function Sidebar({ children, className = '', style = {}, ...props }: SidebarProps) {
  const { isMobile, state, openMobile, setOpenMobile, collapsible, side, variant } = useSidebar()
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          ...
          <div className='overlow-hidden flex h-full w-full flex-col'>{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
