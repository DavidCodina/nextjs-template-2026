...
type SidebarContext = {
  ...
  // Added.
  setCollapsible: React.Dispatch<React.SetStateAction<'offcanvas' | 'icon' | 'none'>>
  // Added.
  side: 'left' | 'right'
...
function SidebarProvider({
  ...
  const [collapsible, setCollapsible] = React.useState<'offcanvas' | 'icon' | 'none'>(defaultCollapsible)
