  ...
  return (
    <Fragment>
      <section className='mx-auto max-w-lg rounded-lg border border-gray-300 bg-[#fafafa] p-4 shadow'>
        <div>
          <label className='mb-1 w-full text-sm font-bold text-blue-500' htmlFor='my-input'>
          ...
          <input
            ...
            value={value}
          />
          <div className='mb-4 text-[12px] text-gray-400'>Debounced value will output below.</div>
        </div>
