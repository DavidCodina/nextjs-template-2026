...
describe('toHaveAccessibleDescription...', () => {
  test('should pass', () => {
    ...
    expect(screen.getByTestId('logo')).toHaveAccessibleDescription('The logo of Our Company')
    expect(screen.getByTestId('logo2')).toHaveAccessibleDescription('The logo of Our Company')
  })
})
