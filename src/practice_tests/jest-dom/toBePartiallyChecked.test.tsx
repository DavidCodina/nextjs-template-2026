...
describe('toBePartiallyChecked...', () => {
  test('should pass', () => {
    render(
      <>
        <input aria-checked='mixed' data-testid='aria-checkbox-mixed' type='checkbox' />
    ...
    const inputCheckboxIndeterminate = screen.getByTestId('input-checkbox-indeterminate') as HTMLInputElement
