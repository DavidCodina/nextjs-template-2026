    ...
    render(
      <>
        <form data-testid='login-form'>
          <input name='username' onChange={() => {}} type='text' value='jane.doe' />
          <input type='password' name='password' onChange={() => {}} value='12345678' />
          <input checked type='checkbox' name='rememberMe' onChange={() => {}} />
