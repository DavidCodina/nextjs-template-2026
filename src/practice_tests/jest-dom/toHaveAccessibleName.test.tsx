...
describe('toHaveAccessibleName...', () => {
  test('should pass', () => {
    render(
      <>
        <img data-testid='img-alt' src='./void.jpg' alt='Test alt' />

        <img data-testid='img-empty-alt' src='./void.jpg' alt='' />
        ...
        <button data-testid='button-img-alt'>
          <img src='./void.jpg' alt='Test' />
        </button>

        <p>
          <img data-testid='img-paragraph' src='./void.jpg' alt='' /> Test content
        </p>
