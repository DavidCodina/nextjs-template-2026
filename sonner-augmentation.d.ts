...
declare module 'sonner' {
  const toast: ((message: titleT | React.ReactNode, data?: ExternalToast) => string | number) & {
    primary: (message: titleT | React.ReactNode, data?: ExternalToast) => string | number

    secondary: (message: titleT | React.ReactNode, data?: ExternalToast) => string | number
